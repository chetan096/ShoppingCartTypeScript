...
app.use(express.static('out/public/css'))
app.use(express.static('out/public/view'))
app.use(express.static('out/public/images'))
...
//   next()
// })
// create public a static website run index file by defaul
...
app.use('/api', indexRoute); // it will mount index.js on this path
